...
export default function OrphanageDetails() {
  ...
  //aqui temos o acesso ao id que está sendo acessado
  // console.log(route.params);

  //estamos forçando dizendo que nosso route params tem esse formato aqui
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          <MapView
            initialRegion={{
              latitude: orphanage?.latitude || -29.68571,
              longitude: orphanage?.longitude || -51.1273791,
              latitudeDelta: 0.008,
